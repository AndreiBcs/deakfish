...
static Bitboard wKingAndRooks;
static Bitboard bKingAndRooks;
...
Bitboard *whiteKingAndRooks = &wKingAndRooks;
Bitboard *blackKingAndRooks = &bKingAndRooks;
...
void initBitboards()
{
    ...
    *whiteKing = (1ULL << 60);
    *blackKing = (1ULL << 4);
    *whiteKingAndRooks = *whiteKing | *whiteRooks;
    *blackKingAndRooks = *blackKing | *blackRooks;
